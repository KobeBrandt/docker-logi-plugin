namespace Loupedeck.DockerPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.DockerPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.DockerPlugin.Resources.Resource.txt`.
